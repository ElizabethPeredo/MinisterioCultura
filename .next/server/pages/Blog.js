...
function Card({ post  }) {
    return /*#__PURE__*/ jsx_runtime_.jsx(jsx_runtime_.Fragment, {
        children: /*#__PURE__*/ (0,jsx_runtime_.jsxs)("div", {
            className: `card-post ${post.frontmatter.type} m-6 flex flex-col bg-white rounded-lg border shadow-lg w-3/4 md:flex-row md:min-w-3xl md:max-w-3xl lg:max-w-2xl dark:bg-white`,
            children: [
                /*#__PURE__*/ jsx_runtime_.jsx("img", {
                    className: "object-cover rounded-t-lg h-52 md:w-2/6 md:h-auto md:rounded-none md:rounded-l-lg",
                    src: post.frontmatter.cover_image,
                    alt: ""
                }),
                /*#__PURE__*/ (0,jsx_runtime_.jsxs)("div", {
                    className: "py-3 px-6 md:w-4/6",
                    children: [
                        ...
                        /*#__PURE__*/ jsx_runtime_.jsx((link_default()), {
                            ...
                            children: /*#__PURE__*/ jsx_runtime_.jsx("a", {
                                href: "#",
                                className: "inline-flex items-center py-2 px-3 text-base font-medium text-center text-white bg-color2 rounded-lg hover:bg-color2-800 focus:ring-4 focus:outline-none focus:ring-color2-300 dark:bg-color2-600 dark:hover:bg-hv-color1 dark:focus:ring-color2-800",
...
function CardContainer({ children  }) {
    return /*#__PURE__*/ jsx_runtime_.jsx("section", {
        ...
        children: /*#__PURE__*/ jsx_runtime_.jsx("main", {
            className: "flex flex-wrap -mx-4 mb-12 md:mb-20 justify-center",
            children: children
        })
    });
};
